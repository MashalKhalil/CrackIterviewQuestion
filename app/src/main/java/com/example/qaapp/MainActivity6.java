...
public class MainActivity6 extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        simple_quest= getResources().getStringArray(R.array.question);
        simple_ans=getResources().getStringArray(R.array.answer);
        ...
        left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(index==0) {
                    Toast.makeText(MainActivity6.this,"NO Questions:",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    index--;
        ...
        right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(index==simple_quest.length-1) {
                    Toast.makeText(MainActivity6.this,"No More Questions:",Toast.LENGTH_SHORT).show();
